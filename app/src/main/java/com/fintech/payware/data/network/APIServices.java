package com.fintech.payware.data.network;

import com.fintech.payware.activities.mahagrm_bc.BCRegisterResponse;
import com.fintech.payware.data.accountop.AccountOPeningResponse;
import com.fintech.payware.data.bbpsresponse.BBPSOPResponse;
import com.fintech.payware.data.bc_response.BcDistrictDto;
import com.fintech.payware.data.bc_response.BcStateDto;
import com.fintech.payware.data.browseplan.BrowsePlanResponse;
import com.fintech.payware.data.db.entities.AuthData;
import com.fintech.payware.data.deer_response.CFPOTPResponse;
import com.fintech.payware.data.deer_response.CFPStatusCheck;
import com.fintech.payware.data.deer_response.CFPTransaction;
import com.fintech.payware.data.deer_response.RechargeResponse;
import com.fintech.payware.data.dthinfo.DthInfoResponse;
import com.fintech.payware.data.dto.CreditCardHistory;
import com.fintech.payware.data.dto.MahagramResponse;
import com.fintech.payware.data.dto.PaysprintResponse;
import com.fintech.payware.data.fastag.FastagBillFetch;
import com.fintech.payware.data.hlr.HLRResponse;
import com.fintech.payware.data.model.AEPSBanksModel;
import com.fintech.payware.data.model.BankModel;
import com.fintech.payware.data.model.ComPackageModel;
import com.fintech.payware.data.model.GraphModel;
import com.fintech.payware.data.model.HelpSupport;
import com.fintech.payware.data.model.HistoryModel;
import com.fintech.payware.data.model.OperatorModel;
import com.fintech.payware.data.model.PayoutUserModel;
import com.fintech.payware.data.model.SliderItem;
import com.fintech.payware.data.model.TicketHistoryModel;
import com.fintech.payware.data.network.dmt.FetchBeneficiaryResponse;
import com.fintech.payware.data.network.responses.AddBeneficiaryResponse;
import com.fintech.payware.data.network.responses.AePSBalanceEnquiryResponse;
import com.fintech.payware.data.network.responses.AnalCardReport;
import com.fintech.payware.data.network.responses.AnalyticsResponseModel;
...
import com.fintech.payware.data.network.responses.BeneHistoryUpdateResponse;
import com.fintech.payware.data.network.responses.BeneficiaryDeleteResponse;
import com.fintech.payware.data.network.responses.BeneficiaryHistoryResponse;
import com.fintech.payware.data.network.responses.CCGenerateOtpResponse;
import com.fintech.payware.data.network.responses.CommissionResponse;
import com.fintech.payware.data.network.responses.ConfirmationResponse;
import com.fintech.payware.data.network.responses.CustomerInfoResponse;
import com.fintech.payware.data.network.responses.DMTSendAmountResponse;
import com.fintech.payware.data.network.responses.DetailedHistoryResponse;
import com.fintech.payware.data.network.responses.DmtUserData;
import com.fintech.payware.data.network.responses.FetchBillInfo;
import com.fintech.payware.data.network.responses.GatewayResponse;
import com.fintech.payware.data.network.responses.LicFetchResponse;
import com.fintech.payware.data.network.responses.MiniStatementResponse;
import com.fintech.payware.data.network.responses.MyOfferResponse;
import com.fintech.payware.data.network.responses.NumberPayResponse;
...
import com.fintech.payware.data.network.responses.PackageResponseData;
import com.fintech.payware.data.network.responses.PayoutAddResponse;
import com.fintech.payware.data.network.responses.PayoutListResponse;
import com.fintech.payware.data.network.responses.PayoutResponse;
import com.fintech.payware.data.network.responses.PaytmTokenInformation;
import com.fintech.payware.data.network.responses.PennyDropResponse;
import com.fintech.payware.data.network.responses.PlanType;
import com.fintech.payware.data.network.responses.QRResponse;
import com.fintech.payware.data.network.responses.QueryRemitterResponse;
import com.fintech.payware.data.network.responses.RegisterRemitterResponse;
...
import com.fintech.payware.data.network.responses.UserTypeResponse;
import com.fintech.payware.data.sys.TPinResponse;
import com.fintech.payware.data_model.LoginModel;
import com.fintech.payware.data_model.request.RequestedHistoryModel;
