package com.fintech.payware.clean.util.common
...
import com.fintech.payware.ui.theme.IconColor
    ...
    trailingIcon: (@Composable () -> Unit)? = {
        Image(
            modifier = Modifier
                .size(24.dp)
                .padding(end = 10.dp),
            painter = painterResource(id =  com.fintech.payware.R.drawable.focus),
