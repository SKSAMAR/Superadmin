package com.fintech.prepe.data.network;

import com.fintech.prepe.activities.mahagrm_bc.BCRegisterResponse;
import com.fintech.prepe.data.accountop.AccountOPeningResponse;
import com.fintech.prepe.data.bbpsresponse.BBPSOPResponse;
import com.fintech.prepe.data.bc_response.BcDistrictDto;
import com.fintech.prepe.data.bc_response.BcStateDto;
import com.fintech.prepe.data.browseplan.BrowsePlanResponse;
import com.fintech.prepe.data.db.entities.AuthData;
import com.fintech.prepe.data.deer_response.CFPOTPResponse;
import com.fintech.prepe.data.deer_response.CFPStatusCheck;
import com.fintech.prepe.data.deer_response.CFPTransaction;
import com.fintech.prepe.data.deer_response.RechargeResponse;
import com.fintech.prepe.data.dthinfo.DthInfoResponse;
import com.fintech.prepe.data.dto.CreditCardHistory;
import com.fintech.prepe.data.dto.MahagramResponse;
import com.fintech.prepe.data.dto.PaysprintResponse;
import com.fintech.prepe.data.fastag.FastagBillFetch;
import com.fintech.prepe.data.hlr.HLRResponse;
import com.fintech.prepe.data.model.AEPSBanksModel;
import com.fintech.prepe.data.model.BankModel;
import com.fintech.prepe.data.model.ComPackageModel;
...
import com.fintech.prepe.data.model.PayoutUserModel;
import com.fintech.prepe.data.model.SliderItem;
import com.fintech.prepe.data.model.TicketHistoryModel;
import com.fintech.prepe.data.network.dmt.FetchBeneficiaryResponse;
import com.fintech.prepe.data.network.responses.AddBeneficiaryResponse;
import com.fintech.prepe.data.network.responses.AePSBalanceEnquiryResponse;
...
import com.fintech.prepe.data.network.responses.BeneHistoryUpdateResponse;
import com.fintech.prepe.data.network.responses.BeneficiaryDeleteResponse;
import com.fintech.prepe.data.network.responses.BeneficiaryHistoryResponse;
import com.fintech.prepe.data.network.responses.CCGenerateOtpResponse;
import com.fintech.prepe.data.network.responses.CommissionResponse;
...
import com.fintech.prepe.data.network.responses.DMTSendAmountResponse;
...
import com.fintech.prepe.data.network.responses.FetchBillInfo;
import com.fintech.prepe.data.network.responses.GatewayResponse;
import com.fintech.prepe.data.network.responses.LicFetchResponse;
import com.fintech.prepe.data.network.responses.MiniStatementResponse;
import com.fintech.prepe.data.network.responses.MyOfferResponse;
import com.fintech.prepe.data.network.responses.NumberPayResponse;
import com.fintech.prepe.data.network.responses.OnlineFundResponse;
...
import com.fintech.prepe.data.network.responses.PennyDropResponse;
import com.fintech.prepe.data.network.responses.PlanType;
import com.fintech.prepe.data.network.responses.QRResponse;
import com.fintech.prepe.data.network.responses.QueryRemitterResponse;
import com.fintech.prepe.data.network.responses.RegisterRemitterResponse;
...
import com.fintech.prepe.data.network.responses.SystemResponse;
import com.fintech.prepe.data.network.responses.UserTypeResponse;
import com.fintech.prepe.data.sys.TPinResponse;
import com.fintech.prepe.data_model.LoginModel;
import com.fintech.prepe.data_model.request.RequestedHistoryModel;
