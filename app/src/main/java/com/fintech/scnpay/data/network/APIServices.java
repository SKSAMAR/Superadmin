...
import com.fintech.scnpay.activities.mahagrm_bc.BCRegisterResponse;
import com.fintech.scnpay.data.accountop.AccountOPeningResponse;
import com.fintech.scnpay.data.bbpsresponse.BBPSOPResponse;
import com.fintech.scnpay.data.bc_response.BcDistrictDto;
import com.fintech.scnpay.data.bc_response.BcStateDto;
import com.fintech.scnpay.data.browseplan.BrowsePlanResponse;
import com.fintech.scnpay.data.db.entities.AuthData;
import com.fintech.scnpay.data.deer_response.CFPOTPResponse;
import com.fintech.scnpay.data.deer_response.CFPStatusCheck;
import com.fintech.scnpay.data.deer_response.CFPTransaction;
import com.fintech.scnpay.data.deer_response.RechargeResponse;
import com.fintech.scnpay.data.dthinfo.DthInfoResponse;
import com.fintech.scnpay.data.dto.CreditCardHistory;
import com.fintech.scnpay.data.dto.MahagramResponse;
import com.fintech.scnpay.data.dto.PaysprintResponse;
import com.fintech.scnpay.data.fastag.FastagBillFetch;
import com.fintech.scnpay.data.hlr.HLRResponse;
import com.fintech.scnpay.data.model.AEPSBanksModel;
import com.fintech.scnpay.data.model.BankModel;
import com.fintech.scnpay.data.model.ComPackageModel;
import com.fintech.scnpay.data.model.GraphModel;
import com.fintech.scnpay.data.model.HelpSupport;
import com.fintech.scnpay.data.model.HistoryModel;
import com.fintech.scnpay.data.model.OperatorModel;
import com.fintech.scnpay.data.model.PayoutUserModel;
import com.fintech.scnpay.data.model.SliderItem;
import com.fintech.scnpay.data.model.TicketHistoryModel;
import com.fintech.scnpay.data.network.dmt.FetchBeneficiaryResponse;
import com.fintech.scnpay.data.network.responses.AddBeneficiaryResponse;
import com.fintech.scnpay.data.network.responses.AePSBalanceEnquiryResponse;
...
import com.fintech.scnpay.data.network.responses.BeneHistoryUpdateResponse;
import com.fintech.scnpay.data.network.responses.BeneficiaryDeleteResponse;
import com.fintech.scnpay.data.network.responses.BeneficiaryHistoryResponse;
import com.fintech.scnpay.data.network.responses.CCGenerateOtpResponse;
import com.fintech.scnpay.data.network.responses.CommissionResponse;
import com.fintech.scnpay.data.network.responses.ConfirmationResponse;
import com.fintech.scnpay.data.network.responses.CustomerInfoResponse;
import com.fintech.scnpay.data.network.responses.DMTSendAmountResponse;
...
import com.fintech.scnpay.data.network.responses.FetchBillInfo;
import com.fintech.scnpay.data.network.responses.GatewayResponse;
import com.fintech.scnpay.data.network.responses.LicFetchResponse;
import com.fintech.scnpay.data.network.responses.MiniStatementResponse;
import com.fintech.scnpay.data.network.responses.MyOfferResponse;
import com.fintech.scnpay.data.network.responses.NumberPayResponse;
import com.fintech.scnpay.data.network.responses.OnlineFundResponse;
import com.fintech.scnpay.data.network.responses.OperatorResponse;
import com.fintech.scnpay.data.network.responses.PackageResponseData;
import com.fintech.scnpay.data.network.responses.PayoutAddResponse;
import com.fintech.scnpay.data.network.responses.PayoutListResponse;
import com.fintech.scnpay.data.network.responses.PayoutResponse;
import com.fintech.scnpay.data.network.responses.PaytmTokenInformation;
import com.fintech.scnpay.data.network.responses.PennyDropResponse;
import com.fintech.scnpay.data.network.responses.PlanType;
import com.fintech.scnpay.data.network.responses.QRResponse;
...
import com.fintech.scnpay.data.network.responses.SlabInfoResponse;
import com.fintech.scnpay.data.network.responses.SystemResponse;
import com.fintech.scnpay.data.network.responses.UserTypeResponse;
import com.fintech.scnpay.data.sys.TPinResponse;
import com.fintech.scnpay.data_model.LoginModel;
