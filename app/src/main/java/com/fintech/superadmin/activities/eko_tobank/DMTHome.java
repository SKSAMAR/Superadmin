...
import com.fintech.superadmin.adapters.DmtUserAdapter;
import com.fintech.superadmin.data.network.responses.DmtUserData;
import com.fintech.superadmin.databinding.ActivityEkoDmthomeBinding;
import com.fintech.superadmin.listeners.DMTAccountListener;
...
public class DMTHome extends BaseActivity implements DMTHomeListeners, DMTAccountListener {
    ...
    ActivityEkoDmthomeBinding binding;
    EkoToBankViewModel viewModel;
    DmtUserAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityEkoDmthomeBinding.inflate(getLayoutInflater());
