...
import com.fintech.superadmin.ui.theme.OkColor
...
fun ContentComposableDialog(
    ...
    AlertDialog(
        modifier = Modifier.heightIn(min = 80.sdp, max = height.sdp).padding(horizontal = 20.sdp),
            ...
            Column(
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
                    Image(
                        ...
                        painter = painterResource(id = R.drawable.cross_exit),
...
@Preview(showBackground = true)
@Composable
fun ContentComposableDialogBig(
    onDismissRequest: (Boolean) -> Unit = {},
    onCancel: () -> Unit = {},
    onAccept: () -> Unit = {},
    content: @Composable ColumnScope.() -> Unit = {}
    ...
    AlertDialog(
        modifier = Modifier.heightIn(min = 80.sdp, max = data.screenHeightDp.sdp).padding(horizontal = 5.sdp),
        onDismissRequest = { onCancel() },
        properties = DialogProperties(
            dismissOnBackPress = true,
            dismissOnClickOutside = true,
...
fun SuccessMessageDialog(
    ...
    AlertDialog(modifier = Modifier.padding(horizontal = 30.sdp),
        onDismissRequest = { onCancel() },
        properties = DialogProperties(
            dismissOnBackPress = true,
            dismissOnClickOutside = true,
        ...
        buttons = {
            BaseButton(modifier = Modifier.padding(start = 15.sdp, end = 15.sdp, bottom = 10.sdp),
                text = "OK",
                fontSize = 14.textSdp,
                onClick = {
                    onAccept()
    ...
    AlertDialog(
        ...
        buttons = {
            Column(
                ...
                ScreenAnimation(
                    modifier = Modifier.size(130.sdp), resources = R.raw.dialog_success
                )
                Spacer(modifier = Modifier.height(10.sdp))
                Text(
                    text = message,
    ...
    AlertDialog(
        ...
        buttons = {
            Column(
                ...
                Spacer(modifier = Modifier.height(30.sdp))
                ScreenAnimation(
                    modifier = Modifier.size(130.sdp), resources = R.raw.dialog_loading
                )
                Spacer(modifier = Modifier.height(10.sdp))
                Text(
                    text = message,
    ...
    AlertDialog(
        ...
        buttons = {
            Column(
                ...
                Spacer(modifier = Modifier.height(30.sdp))
                ScreenAnimation(
                    modifier = Modifier.size(130.sdp), resources = R.raw.dialog_failure
                )
                Spacer(modifier = Modifier.height(10.sdp))
                Text(
                    text = message,
...
fun FailureMessageDialogXX(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        AlertDialog(modifier = Modifier.align(Alignment.Center),
            ...
            buttons = {
                BaseButton(modifier = Modifier.padding(
                    start = 15.sdp,
                    end = 15.sdp,
                    bottom = 10.sdp
                ),
...
fun LoadingMessageDialog(
    ...
    AlertDialog(onDismissRequest = { onCancel() }, properties = DialogProperties(
        dismissOnBackPress = true,
        dismissOnClickOutside = true,
        usePlatformDefaultWidth = false,
        decorFitsSystemWindows = true,
