package com.fintech.webspidysoftware.data.network;

import com.fintech.webspidysoftware.activities.mahagrm_bc.BCRegisterResponse;
import com.fintech.webspidysoftware.data.accountop.AccountOPeningResponse;
import com.fintech.webspidysoftware.data.bbpsresponse.BBPSOPResponse;
import com.fintech.webspidysoftware.data.bc_response.BcDistrictDto;
import com.fintech.webspidysoftware.data.bc_response.BcStateDto;
import com.fintech.webspidysoftware.data.browseplan.BrowsePlanResponse;
import com.fintech.webspidysoftware.data.db.entities.AuthData;
import com.fintech.webspidysoftware.data.deer_response.CFPOTPResponse;
import com.fintech.webspidysoftware.data.deer_response.CFPStatusCheck;
import com.fintech.webspidysoftware.data.deer_response.CFPTransaction;
import com.fintech.webspidysoftware.data.deer_response.RechargeResponse;
import com.fintech.webspidysoftware.data.dthinfo.DthInfoResponse;
import com.fintech.webspidysoftware.data.dto.CreditCardHistory;
import com.fintech.webspidysoftware.data.dto.MahagramResponse;
import com.fintech.webspidysoftware.data.dto.PaysprintResponse;
import com.fintech.webspidysoftware.data.fastag.FastagBillFetch;
import com.fintech.webspidysoftware.data.hlr.HLRResponse;
import com.fintech.webspidysoftware.data.model.AEPSBanksModel;
import com.fintech.webspidysoftware.data.model.BankModel;
import com.fintech.webspidysoftware.data.model.ComPackageModel;
import com.fintech.webspidysoftware.data.model.GraphModel;
import com.fintech.webspidysoftware.data.model.HelpSupport;
import com.fintech.webspidysoftware.data.model.HistoryModel;
import com.fintech.webspidysoftware.data.model.OperatorModel;
import com.fintech.webspidysoftware.data.model.PayoutUserModel;
import com.fintech.webspidysoftware.data.model.SliderItem;
import com.fintech.webspidysoftware.data.model.TicketHistoryModel;
import com.fintech.webspidysoftware.data.network.dmt.FetchBeneficiaryResponse;
import com.fintech.webspidysoftware.data.network.responses.AddBeneficiaryResponse;
import com.fintech.webspidysoftware.data.network.responses.AePSBalanceEnquiryResponse;
...
import com.fintech.webspidysoftware.data.network.responses.BeneHistoryUpdateResponse;
import com.fintech.webspidysoftware.data.network.responses.BeneficiaryDeleteResponse;
import com.fintech.webspidysoftware.data.network.responses.BeneficiaryHistoryResponse;
import com.fintech.webspidysoftware.data.network.responses.CCGenerateOtpResponse;
import com.fintech.webspidysoftware.data.network.responses.CommissionResponse;
import com.fintech.webspidysoftware.data.network.responses.ConfirmationResponse;
import com.fintech.webspidysoftware.data.network.responses.CustomerInfoResponse;
import com.fintech.webspidysoftware.data.network.responses.DMTSendAmountResponse;
...
import com.fintech.webspidysoftware.data.network.responses.FetchBillInfo;
import com.fintech.webspidysoftware.data.network.responses.GatewayResponse;
import com.fintech.webspidysoftware.data.network.responses.LicFetchResponse;
import com.fintech.webspidysoftware.data.network.responses.MiniStatementResponse;
import com.fintech.webspidysoftware.data.network.responses.MyOfferResponse;
import com.fintech.webspidysoftware.data.network.responses.NumberPayResponse;
import com.fintech.webspidysoftware.data.network.responses.OnlineFundResponse;
import com.fintech.webspidysoftware.data.network.responses.OperatorResponse;
import com.fintech.webspidysoftware.data.network.responses.PackageResponseData;
import com.fintech.webspidysoftware.data.network.responses.PayoutAddResponse;
import com.fintech.webspidysoftware.data.network.responses.PayoutListResponse;
import com.fintech.webspidysoftware.data.network.responses.PayoutResponse;
import com.fintech.webspidysoftware.data.network.responses.PaytmTokenInformation;
import com.fintech.webspidysoftware.data.network.responses.PennyDropResponse;
import com.fintech.webspidysoftware.data.network.responses.PlanType;
import com.fintech.webspidysoftware.data.network.responses.QRResponse;
import com.fintech.webspidysoftware.data.network.responses.QueryRemitterResponse;
import com.fintech.webspidysoftware.data.network.responses.RegisterRemitterResponse;
import com.fintech.webspidysoftware.data.network.responses.RegularHistoryResponse;
import com.fintech.webspidysoftware.data.network.responses.RegularResponse;
import com.fintech.webspidysoftware.data.network.responses.SlabInfoResponse;
import com.fintech.webspidysoftware.data.network.responses.SystemResponse;
import com.fintech.webspidysoftware.data.network.responses.UserTypeResponse;
import com.fintech.webspidysoftware.data.sys.TPinResponse;
...
public interface APIServices {
    ...
    Observable<HLRResponse> getHLRInformation(@Field("type") String type, @Field("number") String number,
    ...
    @FormUrlEncoded
    @POST("Backend/Merchant/API/Recharge/PaySprint/recharge.php")
    Observable<RechargeResponse> makeThePayment(@Field("recharge_mobile") String recharge_mobile, @Field("recharge_amount") String recharge_amount,
    ...
    @FormUrlEncoded
    @POST("Backend/Merchant/API/Recharge/PaySprint/recharge.php")
    Observable<BrowsePlanResponse> browsePlan(@Field("op") String op, @Field("circle") String circle, @Field("check_plan") String check_plan);


    @FormUrlEncoded
    @POST("Backend/Merchant/API/Recharge/PaySprint/recharge.php")
    Observable<DthInfoResponse> dth_info(@Field("ca") String ca, @Field("op") String op, @Field("dth_info") String dth_info);
    ...
    @FormUrlEncoded
    @POST("mobile_phone/add_fund/exchange_fund.php")
    Observable<AuthResponse> exchangeWallet(@Field("mobile") String mobile, @Field("password") String password, @Field("token") String token, @Field("amount") String amount);

    @FormUrlEncoded
    @POST("mobile_phone/add_fund/offline_fund.php")
    Observable<RegularResponse> offlineWalletDemand(@Field("mobile") String mobile, @Field("password") String password, @Field("token") String token, @Field("amount") String amount, @Field("payment_mode") String payment_mode, @Field("transaction_id") String transaction_id, @Field("remarks") String remakrs, @Field("receipt") String receipt);
    ...
    Observable<RegularResponse> payFastAgBill(@Field("canumber") String num, @Field("operator") String operator,
                                              @Field("billDetails") String billDetails, @Field("long") String longi,
