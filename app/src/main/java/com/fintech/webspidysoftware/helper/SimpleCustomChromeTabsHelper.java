package com.fintech.webspidysoftware.helper;
...
public class SimpleCustomChromeTabsHelper {
    ...
    private final CustomTabsServiceConnection mCustomTabConnection = new CustomTabsServiceConnection() {
        @Override
    ...
    private final SparseArrayCompat<CustomTabsCallback> mCallbacks = new SparseArrayCompat<>();
    ...
    public static final class CustomTabsUiBuilder {
