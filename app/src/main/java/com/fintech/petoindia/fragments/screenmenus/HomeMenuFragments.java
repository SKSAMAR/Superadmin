package com.fintech.petoindia.fragments.screenmenus;
...
import com.fintech.petoindia.activities.addfunds.AddFundList;
import com.fintech.petoindia.activities.aeps.AepsHome;
import com.fintech.petoindia.activities.aeps.BalanceEnquiry;
import com.fintech.petoindia.activities.aeps.CashWithdrawal;
import com.fintech.petoindia.activities.aeps.MiniStatement;
import com.fintech.petoindia.activities.bbps.BbpsEnter;
import com.fintech.petoindia.activities.creditcard.CCFetchBillK;
import com.fintech.petoindia.activities.fastag.OperatorList;
import com.fintech.petoindia.activities.lic.LicFetchBill;
import com.fintech.petoindia.activities.mahagrm_bc.BcRegistration;
import com.fintech.petoindia.activities.microatm.MicroAtmHome;
import com.fintech.petoindia.activities.mobilenumber.SendMoney;
import com.fintech.petoindia.activities.payoutpaysprint.PaysprintPayout;
import com.fintech.petoindia.activities.rechargeactivities.RechargeMyPlan;
import com.fintech.petoindia.activities.rechargeactivities.SelectOperator;
import com.fintech.petoindia.activities.tobank.QueryRemitter;
...
import com.fintech.petoindia.data.dto.MahagramApiCred;
import com.fintech.petoindia.data.dto.MahagramMerchant;
import com.fintech.petoindia.data.dto.PaysprintApiCred;
import com.fintech.petoindia.data.dto.PaysprintMerchantCred;
import com.fintech.petoindia.data.model.MenuModel;
import com.fintech.petoindia.data.network.responses.AuthResponse;
import com.fintech.petoindia.databinding.FragmentHomeMenuFragmentsBinding;
import com.fintech.petoindia.fragments.sliders.SliderFragment;
import com.fintech.petoindia.listeners.NumberPayListener;
import com.fintech.petoindia.listeners.RecyclerViewClickListener;
import com.fintech.petoindia.log.MahaDashActReturnResp;
import com.fintech.petoindia.log.MahaDashActSendResp;
import com.fintech.petoindia.util.Accessable;
import com.fintech.petoindia.util.Constant;
...
import com.fintech.petoindia.viewmodel.HomeViewModel;
...
public class HomeMenuFragments extends Fragment implements RecyclerViewClickListener, NumberPayListener {
    ...
    public void onRecyclerViewClickItem(View view, MenuModel model) {
        switch (model.getTitle()) {
            ...
            case "Apply PAN": {
                String panPage = Constant.BASE_URL + "/Dashboard/User/ApplyPanAgent";
