package com.fintech.petoindia.di;
...
import com.fintech.petoindia.data.network.NetworkConnectionInterceptor;
import com.fintech.petoindia.data.repositories.UserRepository;
...
public class AppModule {
        ...
        OkHttpClient.Builder httpClient = new OkHttpClient.Builder()
                ...
                **/
                .hostnameVerifier((hostname, session) -> {
                    ...
                    return hv.verify(Constant.BASE_URL_DATA, session);
                });
    ...
    @Singleton
    @Provides
    public static APIServices getApiServices(OkHttpClient httpClient) {
    ...
    @Singleton
    @Provides
    public static YesApi getYesAPI(OkHttpClient httpClient) {
        final Gson gson = new GsonBuilder()
                .setLenient()
                .setFieldNamingPolicy(FieldNamingPolicy.IDENTITY)
                .create();
