package com.fintech.petoindia.data.network;

import com.fintech.petoindia.activities.mahagrm_bc.BCRegisterResponse;
import com.fintech.petoindia.data.accountop.AccountOPeningResponse;
import com.fintech.petoindia.data.bbpsresponse.BBPSOPResponse;
import com.fintech.petoindia.data.bc_response.BcDistrictDto;
import com.fintech.petoindia.data.bc_response.BcStateDto;
import com.fintech.petoindia.data.browseplan.BrowsePlanResponse;
import com.fintech.petoindia.data.db.entities.AuthData;
import com.fintech.petoindia.data.deer_response.CFPOTPResponse;
import com.fintech.petoindia.data.deer_response.CFPStatusCheck;
import com.fintech.petoindia.data.deer_response.CFPTransaction;
...
import com.fintech.petoindia.data.dto.CreditCardHistory;
import com.fintech.petoindia.data.dto.MahagramResponse;
import com.fintech.petoindia.data.dto.PaysprintResponse;
import com.fintech.petoindia.data.fastag.FastagBillFetch;
import com.fintech.petoindia.data.hlr.HLRResponse;
import com.fintech.petoindia.data.model.AEPSBanksModel;
import com.fintech.petoindia.data.model.BankModel;
import com.fintech.petoindia.data.model.ComPackageModel;
import com.fintech.petoindia.data.model.GraphModel;
import com.fintech.petoindia.data.model.HelpSupport;
import com.fintech.petoindia.data.model.HistoryModel;
import com.fintech.petoindia.data.model.OperatorModel;
import com.fintech.petoindia.data.model.PayoutUserModel;
import com.fintech.petoindia.data.model.SliderItem;
import com.fintech.petoindia.data.model.TicketHistoryModel;
import com.fintech.petoindia.data.network.dmt.FetchBeneficiaryResponse;
import com.fintech.petoindia.data.network.responses.AddBeneficiaryResponse;
import com.fintech.petoindia.data.network.responses.AePSBalanceEnquiryResponse;
...
import com.fintech.petoindia.data.network.responses.BeneHistoryUpdateResponse;
import com.fintech.petoindia.data.network.responses.BeneficiaryDeleteResponse;
import com.fintech.petoindia.data.network.responses.BeneficiaryHistoryResponse;
import com.fintech.petoindia.data.network.responses.CCGenerateOtpResponse;
import com.fintech.petoindia.data.network.responses.CommissionResponse;
import com.fintech.petoindia.data.network.responses.ConfirmationResponse;
import com.fintech.petoindia.data.network.responses.CustomerInfoResponse;
import com.fintech.petoindia.data.network.responses.DMTSendAmountResponse;
import com.fintech.petoindia.data.network.responses.DetailedHistoryResponse;
...
import com.fintech.petoindia.data.network.responses.GatewayResponse;
import com.fintech.petoindia.data.network.responses.LicFetchResponse;
import com.fintech.petoindia.data.network.responses.MiniStatementResponse;
import com.fintech.petoindia.data.network.responses.MyOfferResponse;
import com.fintech.petoindia.data.network.responses.NumberPayResponse;
import com.fintech.petoindia.data.network.responses.OnlineFundResponse;
import com.fintech.petoindia.data.network.responses.OperatorResponse;
import com.fintech.petoindia.data.network.responses.PackageResponseData;
import com.fintech.petoindia.data.network.responses.PayoutAddResponse;
import com.fintech.petoindia.data.network.responses.PayoutListResponse;
import com.fintech.petoindia.data.network.responses.PayoutResponse;
import com.fintech.petoindia.data.network.responses.PaytmTokenInformation;
import com.fintech.petoindia.data.network.responses.PennyDropResponse;
import com.fintech.petoindia.data.network.responses.PlanType;
import com.fintech.petoindia.data.network.responses.QRResponse;
import com.fintech.petoindia.data.network.responses.QueryRemitterResponse;
import com.fintech.petoindia.data.network.responses.RegisterRemitterResponse;
...
import com.fintech.petoindia.data.network.responses.SlabInfoResponse;
import com.fintech.petoindia.data.network.responses.SystemResponse;
import com.fintech.petoindia.data.network.responses.UserTypeResponse;
import com.fintech.petoindia.data.sys.TPinResponse;
...
public interface APIServices {
    ...
    @FormUrlEncoded
    @POST("Agent/Backend/Recharge/recharge.php")
    Observable<RegularResponse> prepaidRecharge_Status(@Field("ref_id") String ref_id,
                                                       @Field("check_status") String check_status);

    @FormUrlEncoded
    @POST("Agent/Backend/Recharge/recharge.php")
    Observable<BrowsePlanResponse> browsePlan(@Field("op") String op, @Field("check_plan") String check_plan);
