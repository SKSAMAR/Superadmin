...
import com.fintech.petoindia.activities.tobank.SelectBank;
import com.fintech.petoindia.activities.tobank.SelectedBeneficiaryHistory;
import com.fintech.petoindia.adapters.BeneficiaryAdapter;
import com.fintech.petoindia.adapters.SimpleBeneficiaryHistoryAdapter;
...
import com.fintech.petoindia.data.repositories.ToBankRepository;
...
import com.fintech.petoindia.listeners.BeneficiaryHistoryListener;
import com.fintech.petoindia.listeners.DMTHomeListeners;
...
import com.fintech.petoindia.masterListener.NotFoundListener;
        ...
        if (Accessable.isAccessable()) {
            ...
            NetworkUtil.getNetworkResult(
                    ...
                    result -> {
                        ...
                        amount = null;
                        transType = null;
                        DisplayMessageUtil.success(view.getContext(), result.getMessage());
                    }
            );
        }
    }
