package com.fintech.paytoindia.data.network;

import com.fintech.paytoindia.activities.mahagrm_bc.BCRegisterResponse;
import com.fintech.paytoindia.data.accountop.AccountOPeningResponse;
import com.fintech.paytoindia.data.bbpsresponse.BBPSOPResponse;
import com.fintech.paytoindia.data.bc_response.BcDistrictDto;
import com.fintech.paytoindia.data.bc_response.BcStateDto;
import com.fintech.paytoindia.data.browseplan.BrowsePlanResponse;
import com.fintech.paytoindia.data.db.entities.AuthData;
import com.fintech.paytoindia.data.deer_response.CFPOTPResponse;
import com.fintech.paytoindia.data.deer_response.CFPStatusCheck;
import com.fintech.paytoindia.data.deer_response.CFPTransaction;
import com.fintech.paytoindia.data.deer_response.RechargeResponse;
import com.fintech.paytoindia.data.dthinfo.DthInfoResponse;
import com.fintech.paytoindia.data.dto.CreditCardHistory;
import com.fintech.paytoindia.data.dto.MahagramResponse;
import com.fintech.paytoindia.data.dto.PaysprintResponse;
import com.fintech.paytoindia.data.fastag.FastagBillFetch;
import com.fintech.paytoindia.data.hlr.HLRResponse;
...
import com.fintech.paytoindia.data.model.HelpSupport;
import com.fintech.paytoindia.data.model.HistoryModel;
import com.fintech.paytoindia.data.model.OperatorModel;
import com.fintech.paytoindia.data.model.PayoutUserModel;
import com.fintech.paytoindia.data.model.SliderItem;
import com.fintech.paytoindia.data.model.TicketHistoryModel;
import com.fintech.paytoindia.data.network.dmt.FetchBeneficiaryResponse;
import com.fintech.paytoindia.data.network.responses.AddBeneficiaryResponse;
import com.fintech.paytoindia.data.network.responses.AePSBalanceEnquiryResponse;
...
import com.fintech.paytoindia.data.network.responses.BeneHistoryUpdateResponse;
import com.fintech.paytoindia.data.network.responses.BeneficiaryDeleteResponse;
import com.fintech.paytoindia.data.network.responses.BeneficiaryHistoryResponse;
import com.fintech.paytoindia.data.network.responses.CCGenerateOtpResponse;
import com.fintech.paytoindia.data.network.responses.CommissionResponse;
import com.fintech.paytoindia.data.network.responses.ConfirmationResponse;
import com.fintech.paytoindia.data.network.responses.CustomerInfoResponse;
import com.fintech.paytoindia.data.network.responses.DMTSendAmountResponse;
import com.fintech.paytoindia.data.network.responses.DetailedHistoryResponse;
import com.fintech.paytoindia.data.network.responses.DmtUserData;
import com.fintech.paytoindia.data.network.responses.FetchBillInfo;
import com.fintech.paytoindia.data.network.responses.GatewayResponse;
import com.fintech.paytoindia.data.network.responses.LicFetchResponse;
import com.fintech.paytoindia.data.network.responses.MiniStatementResponse;
import com.fintech.paytoindia.data.network.responses.MyOfferResponse;
import com.fintech.paytoindia.data.network.responses.NumberPayResponse;
import com.fintech.paytoindia.data.network.responses.OnlineFundResponse;
import com.fintech.paytoindia.data.network.responses.OperatorResponse;
import com.fintech.paytoindia.data.network.responses.PackageResponseData;
import com.fintech.paytoindia.data.network.responses.PayoutAddResponse;
import com.fintech.paytoindia.data.network.responses.PayoutListResponse;
import com.fintech.paytoindia.data.network.responses.PayoutResponse;
import com.fintech.paytoindia.data.network.responses.PaytmTokenInformation;
import com.fintech.paytoindia.data.network.responses.PennyDropResponse;
import com.fintech.paytoindia.data.network.responses.PlanType;
import com.fintech.paytoindia.data.network.responses.QRResponse;
import com.fintech.paytoindia.data.network.responses.QueryRemitterResponse;
import com.fintech.paytoindia.data.network.responses.RegisterRemitterResponse;
...
import com.fintech.paytoindia.data.network.responses.SlabInfoResponse;
import com.fintech.paytoindia.data.network.responses.SystemResponse;
import com.fintech.paytoindia.data.network.responses.UserTypeResponse;
import com.fintech.paytoindia.data.sys.TPinResponse;
import com.fintech.paytoindia.data_model.LoginModel;
import com.fintech.paytoindia.data_model.request.RequestedHistoryModel;
